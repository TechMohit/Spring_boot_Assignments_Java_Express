...
public class UserService {
	...
	public User getUserDetailsByUserName(String userName) {
		log.info("UserService:: getUserDetailsByUserName {}", userName);
		return userRepository.findByUsername(userName);
	}

	public User getUserDetailsByEmail(String email) {
		log.info("UserService:: getUserDetailsByEmail {}", email);
		return userRepository.findByEmail(email);
	}

	public User getUserDetailsEmailOrUserName(String username, String email) {
		log.info("UserService:: getUserDetailsEmailOrUserName {}", username);
