...
public class ProductController {
	...
	public List<Product> fetchProductBasedOnCategoryName(@PathVariable String name) {
		log.info("ProductController ::fetchProductBasedOnCategoryName{}", name);
		return productService.fetchProductsBasedOnCategory(name);
	}

	// Fetch Product By Bar Code using JPQL
	@GetMapping("product/{inputBarcode}")
	public Product fetchProductBasedBarCodeViaJPQL(@PathVariable String inputBarcode) {
		log.info("ProductController ::fetchProductBasedBarCodeViaJPQL{}", inputBarcode);
		return productService.fetchProductsBasedBarCodeViaJPQL(inputBarcode);
